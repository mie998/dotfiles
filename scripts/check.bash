...
shellcheck "$REPO_DIR/install.sh" "$REPO_DIR/scripts/"*.bash
...
test -f "$TEST_DIR/home/.config/zsh/.zshenv"
test -f "$TEST_DIR/home/.config/nvim/init.lua"
test -f "$TEST_DIR/home/.config/vim/vimrc"
...
test "$(readlink "$TEST_DIR/home/.zshenv")" = ".config/zsh/.zshenv"
test -e "$TEST_DIR/home/.vim"
test -L "$TEST_DIR/home/.vim"
test "$(readlink "$TEST_DIR/home/.vim")" = ".config/vim"
...
test -f "$REPO_DIR/dot_config/zsh/dot_zshenv"
test ! -e "$REPO_DIR/dot_config/vim/.netrwhist"
test ! -e "$REPO_DIR/dot_config/vim/pack"
